...
--   note the array and integer can be distinguish by the symbol "#"   
--   At the end of #n mean the parameter is a array, n is the number of dimension
--------------------------------------------------------------------------------
*/
#define d_is_pake_add_0                1    //if add 0 during the paking funtion

#define d_sequence_num                 1
#define d_group_num                    1
#define d_picture_num                  1
#define d_slice_num                    1
#define d_mb_num                       2

//waring: the max patameter must larger than the corresponding parameter
...
//pic_coding_ext
#define d_picture_coding_extension_id     32'h000001b5    //
#define d_f_code00                        4'b1111    //[1,9,15]
#define d_f_code01                        4'b1111    //[1,9,15]
#define d_f_code10                        4'b1111    //[1,9,15]
#define d_f_code11                        4'b1111    //[1,9,15]
#define d_intra_dc_precision              2'b00
#define Top_Field     2'b01
#define Bottom_Field  2'b10
#define Frame_picture 2'b11
...
//slice
#define d_slice_start_code_value                8'h01  //[01:AF]
#define d_slice_vertical_position_extension     3'b001
#define d_priority_breakpoint                   7'b0000001
#define d_quantiser_scale_code                  5'b00001   //[1:31]
#define d_intra_slice_flag                      1'b1
...
//mb
//#define d_mb_escape_num                      0
#define d_mb_addr_value                        1  //>1
//#define d_mb_addr_increment_index            0
#define d_quantiser_scale_code_mb              5'b00001   //[1:31]
//#define d_macroblock_len                     2        //len of each mb in each slice
//macroblock_type
#define d_macroblock_type_index                1'b0       //for I,B,P type
#define d_spatial_temporal_weight_code         2'b00;
#define d_spatial_temporal_weight_code_inedx_0 1'b1  //1 mean inedx=0
#define d_frame_motion_type                    2'b01
#define d_field_motion_type                    2'b01
#define d_dct_type                             1'b0
//Motion vectors
#define d_motion_vertical_field_select_0s      1'b0
#define d_motion_vertical_field_select_1s      1'b0
//Motion vector
#define d_motion_code_rs0_index                1'b0
#define d_motion_residual_rs0_index            0
#define d_dmvector_0_index                     0
#define d_motion_code_rs1_index                0
#define d_motion_residual_rs1_index            0
#define d_dmvector_1_index                     0
//coded block pattern
#define d_coded_block_pattern_420_index        1'b0
#define d_coded_block_pattern_1                2'b01
#define d_coded_block_pattern_2                6'b000001
//block
//#define d_block_num                            6
#define d_dct_dc_size_luminance_index          0
#define d_dct_dc_differential                  1'b0
#define d_dct_dc_size_chrominance_index        0
#define d_First_DCT_coefficeint_index          2
#define d_Subsequenet_DCT_coefficeint_index    2
#define d_signed_level                         1'b0
#define d_escape_run_index                     0
#define d_escape_level_index                   0
...
#define u_slice_num         u_video.slice.slice_num
#define u_mb_num            u_video.mb.mb_num
...
#define u_block_num                    u_video.seq_ext.block_num               //#
...
#define u_get_motion_residual_len     u_video.pic_coding_ext.get_motion_residual_len   //#
...
//slice
#define u_slice_start_code_value             u_video.slice.slice_start_code_value
#define u_slice_vertical_position_extension  u_video.slice.slice_vertical_position_extension
#define u_priority_breakpoint                u_video.slice.priority_breakpoint
#define u_quantiser_scale_code               u_video.slice.quantiser_scale_code
#define u_intra_slice_flag                   u_video.slice.intra_slice_flag
#define u_intra_slice                        u_video.slice.intra_slice
//#define u_reserved_bit                     u_video.slice.u_reserved_bit
#define u_extra_bit_slice                    u_video.slice.extra_bit_slice
#define u_extra_information_slice            u_video.slice.extra_information_slice
#define u_extra_bit_slice_0                  u_video.slice.extra_bit_slice_0
#define u_slice_len                          u_video.slice.slice_len


//mb
#define u_mb_escape_num                     u_video.mb.mb_escape_num          
#define u_mb_addr_increment_index           u_video.mb.mb_addr_increment_index
                                                                              
#define u_mb_addr_value                     u_video.mb.mb_addr_value          
#define u_quantiser_scale_code_mb           u_video.mb.quantiser_scale_code_mb
#define u_get_vlc_table                     u_video.mb.get_vlc_table          
#define u_vlc_len                           u_video.mb.vlc_len                          
#define u_vlc_value                         u_video.mb.vlc_value                         
#define u_vlc_value_2                       u_video.mb.vlc_value_2                       
#define u_vlc_level                         u_video.mb.vlc_level                         
#define u_macroblock_quant                  u_video.mb.macroblock_quant                  
#define u_macroblock_motion_forward         u_video.mb.macroblock_motion_forward         
#define u_macroblock_motion_backward        u_video.mb.macroblock_motion_backward        
#define u_macroblock_pattern                u_video.mb.macroblock_pattern                
#define u_macroblock_intra                  u_video.mb.macroblock_intra                  
#define u_spatial_temporal_weight_code_flag u_video.mb.spatial_temporal_weight_code_flag 

//macroblock_type
#define u_macroblock_type_index         u_video.mb.macroblock_type_index
#define u_spatial_temporal_weight_code  u_video.mb.spatial_temporal_weight_code
#define u_spatial_temporal_weight_code_inedx_0  u_video.mb.spatial_temporal_weight_code_inedx_0
#define u_frame_motion_type             u_video.mb.frame_motion_type
#define u_field_motion_type             u_video.mb.field_motion_type
#define u_dct_type                      u_video.mb.dct_type
//Motion vectors
#define u_motion_vertical_field_select_0s u_video.mb.motion_vertical_field_select_0s
#define u_motion_vertical_field_select_1s u_video.mb.motion_vertical_field_select_1s 
#define u_get_frame_motion_type           u_video.mb.get_frame_motion_type           
#define u_get_field_motion_type           u_video.mb.get_field_motion_type           
#define u_motion_vector_counter           u_video.mb.motion_vector_counter           
#define u_my_format                       u_video.mb.my_format                       
#define u_dmv                             u_video.mb.dmv                             

//Motion vector
#define u_motion_code_rs0_index           u_video.mb.motion_code_rs0_index    
#define u_motion_residual_rs0_index       u_video.mb.motion_residual_rs0_index  
#define u_dmvector_0_index                u_video.mb.dmvector_0_index           
#define u_motion_code_rs1_index           u_video.mb.motion_code_rs1_index      
#define u_motion_residual_rs1_index       u_video.mb.motion_residual_rs1_index  
#define u_dmvector_1_index                u_video.mb.dmvector_1_index           
//coded block pattern
#define u_coded_block_pattern_420_index   u_video.mb.coded_block_pattern_420_index
#define u_coded_block_pattern_1           u_video.mb.coded_block_pattern_1        
#define u_coded_block_pattern_2           u_video.mb.coded_block_pattern_2        
//block

#define u_dct_dc_size_luminance_index     u_video.mb.dct_dc_size_luminance_index  
#define u_dct_dc_differential             u_video.mb.dct_dc_differential          
#define u_dct_dc_size_chrominance_index   u_video.mb.dct_dc_size_chrominance_index
#define u_First_DCT_coefficeint_index       u_video.mb.First_DCT_coefficeint_index
#define u_Subsequenet_DCT_coefficeint_index u_video.mb.Subsequenet_DCT_coefficeint_index

#define u_pattern_code                    u_video.mb.pattern_code       
#define u_get_pattern_code                u_video.mb.get_pattern_code   
#define u_signed_level                    u_video.mb.signed_level       
#define u_luminance_size                  u_video.mb.luminance_size     
#define u_chrominance_size                u_video.mb.chrominance_size   
#define u_escape_run_index                u_video.mb.escape_run_index   
#define u_escape_level_index              u_video.mb.escape_level_index 
