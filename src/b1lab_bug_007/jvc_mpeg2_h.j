...
/*------------------------------------------------------------------------------
get_motion_residual_len() caculate the the number of bits for motion_resident[r][s][t]
   i=ig.grp_counter-1;h=ig.pic_counter-1; 
   s: forward or backward;t:0 or 1;
   r_size = f_code[s][t] - 1      //6.3.17.3
   The number of bits for both motion_residual[0][s][t] and motion_residual[1][s][t]
   is denoted by f_code[s][t].                                                                               
------------------------------------------------------------------------------*/   
int get_motion_residual_len(int i,int h,bit s,bit t){  
   int len=0;                                                                                       
   if (s==0) {  //f_code[0][t]                                                                                   
      if (t==0) {                                                                                   
         len=f_code00[i][h]-1;                                                                      
   ...
   if (len<=0) {
      printf("error: the get_motion_residual_len is zero,1 will be instead");
      len=1;
   }
   return len;                                                                                      
   } //                                                                                             
...
//------------------------------------------------------------------------------
//function
//check whether the value is 0,the error will report when the value do
...
//check whether the value is 1,the error will report when the value do
...
//check whether the value is reserved,the warning will report when the value do
...
/*------------------------------------------------------------------------------
gen_random() gen the random value between the a and b.
------------------------------------------------------------------------------*/ 
