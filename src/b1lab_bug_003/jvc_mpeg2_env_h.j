...
extern void main();
//extern void trace(jvc_mpeg2_trace_module module_name ,jvc_mpeg2_trace_level level ,
//   string mesg );
...
//enum profile_type=Simple,Main,SNR,Spatial,High;
//enum level_type=low,main,high_1440,high;
