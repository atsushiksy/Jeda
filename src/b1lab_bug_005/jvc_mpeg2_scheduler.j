...
//printf("$$$$$$$$$$$$$$$$$$$$$$$$ig.pic_counter=%d,ig.slice_counter=%d\n",ig.pic_counter,ig.slice_counter);
printf("******************************u_mb_num=%d,u_slice_num=%d\n",u_mb_num[ig.pic_counter][ig.slice_counter],u_slice_num[ig.pic_counter]);

           // if (ig.mb_counter<u_mb_num[ig.pic_counter][ig.slice_counter]) {
if (ig.mb_counter<2) {
               gen_seq_num=9;
            }
            else {
               ig.mb_counter=0;                                             
              // if (ig.slice_counter<u_slice_num[ig.pic_counter]) {
