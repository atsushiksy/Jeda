...
ifeq ($(MACHINE),sparc)
  DFLAG = -D_REENTRANT -DJEDA_SELF_THREAD_CONTROL -DPREALLOCATE_CODE -DPRODUCT_CODE
  LWP_SRC = ${SYSDEP}/jeda_lwp.S
  LWP_OBJ = ${LWP_SRC:.S=.o}
  FLEXLMD = ../../flexlm/v8.3/sun4_u5
else
  DFLAG = -D_REENTRANT -DPREALLOCATE_CODE -DPRODUCT_CODE
  FLEXLMD = ../../flexlm/v8.3/i86_r6
endif
...
CC = gcc  -O2 -lang-c-c++-comments -I ../include -I ../vinclude -I ../readline/readline-4.2 -I ../../flexlm/v8.3/machind -DREADLINE_LIBRARY -D_POSIX_THREADS  -DJEDA_VERILOG_LINK ${DFLAG} -fPIC -DVERILOG_IO

OPCC = gcc  -O2 -lang-c-c++-comments -I ../include -I ../vinclude -I ../readline/readline-4.2 -I ../../flexlm/v8.3/machind -DREADLINE_LIBRARY -D_POSIX_THREADS  -DJEDA_VERILOG_LINK ${DFLAG} -fPIC -DVERILOG_IO ${OPTFLAGS}

#SCC = gcc  -g -lang-c-c++-comments -I ../include -I ../vinclude -D_POSIX_THREADS -D_POSIX_C_SOURCE=199506L -DJEDA_VERILOG_LINK ${DFLAG} -fPIC 

SCC = gcc  -g -lang-c-c++-comments -I ../include -I ../vinclude -I ../readline/readline-4.2 -I ../../flexlm/v8.3/machind -DREADLINE_LIBRARY -D_POSIX_THREADS  -DJEDA_VERILOG_LINK -DJEDA_STANDALONE_MODE ${DFLAG} -fPIC 

SOPCC = gcc  -O2 -lang-c-c++-comments -I ../include -I ../vinclude -I ../readline/readline-4.2 -I ../../flexlm/v8.3/machind -DREADLINE_LIBRARY -D_POSIX_THREADS  -DJEDA_VERILOG_LINK -DJEDA_STANDALONE_MODE ${DFLAG} -fPIC ${OPTFLAGS}

DCC = gcc  -g -lang-c-c++-comments -I ../include -I ../vinclude -I ../readline/readline-4.2 -I ../../flexlm/v8.3/machind -DREADLINE_LIBRARY -D_POSIX_THREADS  -DJEDA_VERILOG_LINK ${DFLAG} -fPIC -DVERILOG_IO -DJEDA_DEBUGGER

SDCC = gcc  -g -lang-c-c++-comments -I ../include -I ../vinclude -I ../readline/readline-4.2 -I ../../flexlm/v8.3/machind -DREADLINE_LIBRARY -D_POSIX_THREADS  -DJEDA_VERILOG_LINK ${DFLAG} -fPIC  -DJEDA_STANDALONE_MODE -DJEDA_DEBUGGER

VCC = gcc  -O2 -lang-c-c++-comments ${ICARUSFLAG} -I ../include -I ../vinclude -I ../readline/readline-4.2 -I ../../flexlm/v8.3/machind -DREADLINE_LIBRARY -D_POSIX_THREADS  -DJEDA_VERILOG_LINK -DJEDA_VPI_MODE ${DFLAG} -fPIC -DVERILOG_IO

VDCC = gcc  -g -lang-c-c++-comments ${ICARUSFLAG} -I ../include -I ../vinclude -I ../readline/readline-4.2 -I ../../flexlm/v8.3/machind -DREADLINE_LIBRARY -D_POSIX_THREADS  -DJEDA_VERILOG_LINK -DJEDA_VPI_MODE ${DFLAG} -fPIC -DVERILOG_IO -DJEDA_DEBUGGER
...
TARGET = ${ALL_OBJ} ${SRUN_OBJ} ${BIT_OBJ} \
         ...
         ${SDBG_YACC_OBJ} ${VDBG_YACC_OBJ} ${LWP_OBJ} ${VPI_OBJ} \
         ${VPIDBG_OBJ} ${JVPI_OBJ} ${COMPILE_INC} ${ALL_MACRO_INC}
...
${RUN_LIB}: ${SRUN_OBJ} ${BIT_OBJ} ${REG_OBJ} ${LWP_OBJ} ${FLEXLM_OBJ}
	${RM} -f $@
	ar -r $@ ${SRUN_OBJ} ${BIT_OBJ} ${REG_OBJ} ${LWP_OBJ} ${FLEXLM_OBJ}


${OPRUN_LIB}: ${SOPRUN_OBJ} ${BIT_OBJ} ${REG_OBJ} ${LWP_OBJ} ${FLEXLM_OBJ}
	${RM} -f $@
	ar -r $@ ${SOPRUN_OBJ} ${BIT_OBJ} ${REG_OBJ} ${LWP_OBJ} ${FLEXLM_OBJ}

${DBG_LIB}: ${SDBG_OBJ} ${BIT_OBJ} ${REG_OBJ} ${SDBG_YACC_OBJ} ${LEX_OBJ} ${LWP_OBJ} ${FLEXLM_OBJ}
	${RM} -f $@
	ar -r $@ ${SDBG_OBJ} ${BIT_OBJ} ${REG_OBJ} ${SDBG_YACC_OBJ} ${LEX_OBJ} ${LWP_OBJ} ${FLEXLM_OBJ}

jedarun.dl: ${RUN_OBJ} ${BIT_OBJ} ${REG_OBJ} ${LWP_OBJ} ${FLEXLM_OBJ}
	${RM} $@
	gcc -shared -o $@ ${RUN_OBJ} ${BIT_OBJ} ${REG_OBJ} ${LWP_OBJ} ${FLEXLM_OBJ}
